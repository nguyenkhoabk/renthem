...
<td style="border:0px solid !important;" valign="bottom"><input type="text" name="clean_date_start" id="clean_date_start" class="caledar" style="text-align: center;" value="<?=date("Y-m-d")?>" /></td>
<td style="border:0px solid !important;" valign="bottom"><input type="text" name="clean_date_end" id="clean_date_end" class="caledar" style="text-align: center;" value="<?=date("Y-m-d")?>" /></td>
