				...
				<input type="hidden" name="edit_client_id" id="edit_client_id" value="<?=$client_id?>" />
								...
								<div class="row">
	  							...
	  							<div class="row">
	  								<div class="booking-column-1">
	  									<label>Comment</label>
	  									<textarea name="edit_comment" id="edit_comment" rows="3"></textarea>
	  								</div>
	  								<div class="clear"></div>
	  							</div>
	  						</div>
  						...
  						<div class="booking-column-2 right-vline">
  							<div class="row">
  								...
  								<div class="booking-column-2">
  									<label>Date</label>
  									<input type="text" name="edit_date" id="edit_date" class="caledar" style="text-align: center;" value="<?=date("Y-m-d")?>" />
  								</div>
  								<div class="clear"></div>
  							</div>
...
?>
	<tr>
		...
		<td><input type="checkbox" value="<?=$service_id_aux?>"		 name="window_service" id="window_id_0_<?=$service_id_aux?>" class="regular-checkbox big-checkbox" /></td>
	</tr>
...
?>
	<tr>
		...
		<td> <input type="checkbox" value="1::<?=$service_id_aux?>" onclick="Checkbox_to_RadioButton(this);" name="clean_service"  id="clean_id_1_<?=$service_id_aux?>"   class="regular-checkbox big-checkbox" /></td>
	</tr>
...
?>
	<tr>
		...
		<td><input type="checkbox"  value="2::<?=$service_id_aux?>"  onclick="Checkbox_to_RadioButton(this);" name="clean_service"  id="clean_id_2_<?=$service_id_aux?>"   class="regular-checkbox big-checkbox" /></td>
	</tr>
...
?>
	<tr>	
		...
		<td><input type="checkbox" value="4::<?=$service_id_aux?>" onclick="Checkbox_to_RadioButton(this);" name="clean_service"  id="clean_id_4_<?=$service_id_aux?>"   class="regular-checkbox big-checkbox" /></td>
	</tr>
...
?>
	<tr>
		...
		<td><input type="checkbox"  value="0::<?=$service_id_aux?>"  onclick="Checkbox_to_RadioButton(this);" name="clean_service"  id="clean_id_0_<?=$service_id_aux?>" class="regular-checkbox big-checkbox" /></td>
	</tr>
		...
		<!--- update price id -->					
				...
				<div class="row">
					...
					<div class="clear"></div>
						...
						<div class="row">
					<div class="booking-column-2">
  					<label><Input type="checkbox" value="1" id="edit_sendUserEmail" name="sendUserEmail" CHECKED /> Send user email</label>
					</div>
				</div>		
						...
						<div class="" style="width:100%; border-top:1px solid #E5E9EC;" id="extra-info">
  						...
  						<div class="tool-bar">
  							...
  							<button class="btn b-save" type="button" onclick="copyBookingNew();" >Save</button>
							
  							<button class="btn b-cancel" type="button"  onclick="showBookInfoPopup('<?=$book_id?>');">Cancel</button>
