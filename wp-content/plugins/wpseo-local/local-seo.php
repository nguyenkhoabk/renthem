...
define( 'WPSEO_LOCAL_VERSION', '1.3.5' );
...
function yoast_wpseo_local_upgrade_error() {
	echo '<div class="error"><p>' . __( 'Please upgrade the WordPress SEO plugin to the latest version to allow the Local SEO module to work.', 'yoast-local-seo' ) . '</p></div>';
}
